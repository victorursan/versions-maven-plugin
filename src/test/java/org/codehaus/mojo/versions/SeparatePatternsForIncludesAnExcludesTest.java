...
public class SeparatePatternsForIncludesAnExcludesTest extends TestCase {
	...
	public void testSeparatePatternWithSeveralPatternsAndRanges() {
		List<String> patterns = mojo.separatePatterns("group:artifact:type:[1.0.2,2.0.0),group2:artifact:type:(1.0.2,2.0.0]");
	...
	public void testSeparatePatternsWithSeveralCommaSeparatedPatterns() {
		List<String> patterns = mojo.separatePatterns("group:artifact:type:version,group:artifact:type:version2,group:artifact:type:version3,group:artifact:type:version4");
